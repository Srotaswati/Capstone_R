...
pentagrams <- data.table(w1 = codes$word, c1 = codes$code, c2 = rotatevec(codes$code),c3 = rotatevec(rotatevec(codes$code)),c4 = rotatevec(rotatevec(rotatevec(codes$code))),c5 = rotatevec(rotatevec(rotatevec(rotatevec(codes$code)))))
